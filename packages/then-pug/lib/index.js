...
var generateCode = require('./pug-code-gen.js');
...
function handleTemplateCache (options, str) {
  ...
  if (options.cache && exports.cache[key]) {
    ...
    var templ = exports.compileStreaming(str, options);
...
*/
  ...
  var fn;
  if (hasGenerators) {
      fn = new Function ('', parsed.body + ';return template;')();
  } else {
      fn = new Function('regeneratorRuntime', parsed.body + ';return template;')(regeneratorRuntime);
  }
